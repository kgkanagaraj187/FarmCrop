 ...
 */
public class OfflineProductReturn {
    ...
    private Set<OfflineProductReturnDetail> offlineProductReturnDetail;
	...
	public void setProductReturnDate(String productReturnDate) {
	...
	public Set<OfflineProductReturnDetail> getOfflineProductReturnDetail() {
		return offlineProductReturnDetail;
	}

	public void setOfflineProductReturnDetail(Set<OfflineProductReturnDetail> offlineProductReturnDetail) {
		this.offlineProductReturnDetail = offlineProductReturnDetail;
	}
