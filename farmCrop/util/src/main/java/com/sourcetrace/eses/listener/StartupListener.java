...
import com.sourcetrace.eses.dao.IDeploymentLogDAO;
import com.sourcetrace.eses.dao.IUptimeLogDAO;
...
public class StartupListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent evt) {
    	try {
	        ...
	        IDeploymentLogDAO deploymentLogDAO = (IDeploymentLogDAO) wac.getBean("deploymentLogDAO");
    ...
    public void contextDestroyed(ServletContextEvent evt) {
        ...
        WebApplicationContext wac = WebApplicationContextUtils.getWebApplicationContext(ctx);
        Deployment deployment = (Deployment) wac.getBean("deployment");
        IUptimeLogDAO uptimeLogDAO = (IUptimeLogDAO) wac.getBean("uptimeLogDAO");
