...
public class PMTDetail {
	...
	private Double mtntQuintalWeight;
	...
	public Double getMtntQuintalWeight() {
		return mtntQuintalWeight;
	}

	public void setMtntQuintalWeight(Double mtntQuintalWeight) {
		this.mtntQuintalWeight = mtntQuintalWeight;
	}
