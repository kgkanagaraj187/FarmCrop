...
public interface ISequenceDAO {
	 ...
	 */
	public abstract Long getShopDealerCardIdSequence();
	...
	/**
	 * Find project code sequence by customer id.
	 * 
	 * @param customerId
	 *            the customer id
	 * @return the customer project sequence
	 */
	public abstract CustomerProjectSequence findProjectCodeSequenceByCustomerId(String customerId);
	...
	public abstract Long getWarehouseIdSeq();
	...
	public abstract Long getProcurementVarietyIdSeq();

	public abstract Long getProcurementGradeIdSeq();
