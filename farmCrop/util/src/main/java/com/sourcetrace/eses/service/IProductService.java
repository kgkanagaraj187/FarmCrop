...
public interface IProductService {
	...
	/**
	 * Edits the warehouse product list.
	 * 
	 * @param productList
	 *            the product list
	 */
	...
	/**
	 * Update village warehouse list.
	 * 
	 * @param villageWarehouseList
	 *            the village warehouse list
	 */
	 ...
	 * @return the product
	 */
	public Product findProductByNameAndUnit(String string, String selectedUnit);
	 ...
	 * @return the list< object[]>
	 */
	public List<Object[]> listProductNameUnitByWarehouseAgentId(String trim, long id);
	 ...
	 * @return the list< object[]>
	 */
	public List<Object[]> listProductNameUnitByWarehouseAgent(long id);
	...
	public WarehouseProduct findCostPriceForAgent(long id, long agentId);
	...
	public void removeCropSupplyDetails(long templateId);
	...
	public List<SubCategory> lisCategoryByWarehouseIdSeasonCode(String trim, String seasonCode);

	public List<Object[]> findFarmerCountCultivationAreaEsiyield(String farmerName, String cropId, String season,
			String samithi, String ics);
	...
	public List<Object> listcowMilkByMonth(Date firstDateOfMonth, Date date);
	...
	List<ProcurementProduct> listProcurmentProductsByFarmer(String farmerId);

	List<Object[]> listWarehouseProductSeason();

	public List<Product> findProductListByBranch(String branchId);

	public List<ProcurementVariety> listProcurmentVarietyByProcurementProductIdInProcurement(String trim);

	public List<Object[]> findProcurementDataByFilter(Long selectedProduct, String selectedDate);

	public List<Object> listProcurementQtyByMoth(Date firstDateOfMonth, Date date);
