 ...
 * SourceTrace Systems.
 */
package com.sourcetrace.esesw.excep;
 ...
 */
public class SwitchException extends RuntimeException implements SwitchErrorCodes {
    ...
    public void loadSwitchErrorCodes() {
        ...
        try {
            errors.load(SwitchException.class.getResourceAsStream("switch-error_en.properties"));
        } catch (IOException e) {
            LOGGER.error("Error reading error codes and messages, switch-error.properties");
        }
    }
}
