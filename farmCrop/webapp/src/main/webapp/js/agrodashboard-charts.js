...
function barChart(chartDivId,chartTitle,chartSubTittle,xaxisCategory,yaxisTitle,tooltipSuffix,legendEnable,stackLabelEnable,seriesdata)
{
	Highcharts.chart(chartDivId, {
	    chart: {
	        type: 'bar'
...
function stackedBarChart(chartDivId,chartTitle,chartSubTittle,xaxisCategory,yaxisTitle,legendEnable,seriesdata)
{
	Highcharts.chart(chartDivId, {
	    chart: {
	        type: 'bar'
...
function pieChart(chartDivId,chartTitle,chartSubTittle,tooltipSuffix,legendEnable,seriesName,seriesdata)
{
	Highcharts.chart(chartDivId, {
	    chart: {        
	        type: 'pie'
