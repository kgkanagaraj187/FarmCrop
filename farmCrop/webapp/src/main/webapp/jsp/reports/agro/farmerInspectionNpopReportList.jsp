...
<body>
	...
	jQuery(document).ready(function(){
		...
		jQuery("#detail").jqGrid(
				{
				   	url:'farmerInspectionNpopReport_data.action?',
		...
		jQuery("#detail").jqGrid('setGridParam',{url:"farmerInspectionNpopReport_data.action?",page:1})
			.trigger('reloadGrid');	
	...
	function exportXLS() {
	    if (isDataAvailable("#detail")) {
	        ...
	        jQuery("#detail").jqGrid('excelExport', {url: 'farmerInspectionNpopReport_populateXLS.action?'});
	}     else {
	...
	function onFilterData(){
		callAjaxMethod("farmerInspectionNpopReport_populateFarmerList.action","farmerId");
		callAjaxMethod("farmerInspectionNpopReport_populateFarmList.action","farmId");
	...
	<s:form name="form" id="filter" action="farmerInspectionNpopReport_list">
			...
			<section class='reportWrap row'>
				<div class="gridly">
					...
					<div class="filterEle">
						...
						<div class="form-element">
							<s:select name="filter.farmId" id="farmId" list="{}" headerKey=""
...
<div class="flexItem text-right flex-right">
	...
	<s:form name="updateform" action="farmerInspectionNpopReport_detail">
		<s:hidden key="id" />
