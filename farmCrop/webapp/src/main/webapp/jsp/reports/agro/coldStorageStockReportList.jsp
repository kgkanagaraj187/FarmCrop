...
var recordLimit='<s:property value="exportLimit"/>';
	...
	function exportXLS(){
		...
		if(count>recordLimit){
			...
			headerData='<s:text name="noofBags"/>'+"###"+totalNoBags+"###"+'<s:text name="netWeight"/>(kgs)'+"###"+totalNetWegt;
			...
			<div class="flexItem-2">
				<div class="summaryBlocksWrapper flex-container ">
					<div class="report-summaryBlockItem">
						<span> <s:text name="noofBags"/>&nbsp;<span class="strong" id="totalNoBags"></span>&nbsp;</span>
					</div>
					<div class="report-summaryBlockItem">
						<span><s:text name="netWeight"/>&nbsp;<span class="strong" id="totalNetWegt"></span>&nbsp;kgs</span>
					</div>
