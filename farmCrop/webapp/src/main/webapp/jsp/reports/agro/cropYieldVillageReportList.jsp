...
var villageCode='';
var listAction = "cropYieldVillageReport_list.action";
var dataAction = "cropYieldVillageReport_data.action";
var subListAction ="cropYieldVillageReport_subList.action?selectedVillage=";
	...
	$(document).ready(function(){
		...
		function reloadGrid(){
			villageCode = document.getElementById("villageId").value;
...
<div id="divs" align="right" class="hide">
	...
	<div class="row">
		...
		<div class="col-md-6" style="width:42%;float: right;">
			...
			<div class="" style="width:50px; float:left; margin:10px;">
				<s:text name="field" />
			</div>
			<div class="" style="width:250px; float:left;">
			 	<s:select name="fieldl" id="fieldl" list="fields" class="form-control"
			 	headerKey="" headerValue="%{getText('txt.select')}" theme="simple" /> &nbsp;
			</div>
			<div class=""  style="width:52px; float:left;">
				<button type="button" class="btn btn-sts" aria-hidden="true" id="plus">
					<b class="fa fa-plus"></b>
				</button>
			</div>
			
			<div class=""  style="width:52px; float:left;">
				<button type="button" class="btn btn-sts" aria-hidden="true" id="minus">
...
<div class="panel panel-default leftSideColumn filterSection" style="margin-top: 0; margin-bottom: 0;">
	<div class="panel-body">
	  	<div class="col-md-3">
			<div class="form-group">
			<td style="width: 80px" colspan="2" rowspan="2"><s:text name="village" /></td>
								<td><s:select id="villageId" name="selectedVillageCode"
						headerKey="" headerValue="%{getText('txt.select')}" list="villageList" theme="simple" cssClass="form-control input-sm select2" cssStyle="margin:5px 0 5px 0;"/></td>
			</div>
		</div>
	</div>
</div>
...
<div class="well well-sm">
			<div class="form-inline">
				<div id="searchbtn">
					<label><s:text name="village" /></label>
					<s:select id="villageId" name="selectedVillageCode"
						headerKey="" headerValue="%{getText('txt.select')}" list="villageList" theme="simple" cssClass="form-control input-sm select2" cssStyle="width:150px"/>
				</div>
...
<s:form name="detailForm" action="cropYieldVillageReport_data">
		<s:hidden name="id" />
