...
<s:hidden key="farmerInspectionNopGroupReport.id"
	id="farmerInspectionNopGroupReportId" />
			...
			<div class="flexWrapper">
				<div class="flexLeft appContentWrapper">
					<div class="formContainerWrapper dynamic-form-con">
						<h2><s:text name="info.farmerInspectionNopGroupReport" /></h2>
						...
						<s:iterator var="questionAnswers"
							...
							<tr>
								...
								<td width="12%" class="break-word"><s:date
										...
										format="%{getGeneralDateFormat().concat(' HH:mm:ss')}" /></td>
...
<s:form name="cancelform" action="farmerInspectionNopGroupReport_list">
	<s:hidden key="currentPage" />
</s:form>
...
function exportPDF(){
	document.form.action = 'farmerInspectionNopGroupReport_populatePdf.action';
...
function getImage(id){
	//modal.open({src: "farmerIn spectionNopReport_getImage.action?id="+id+"&dt="+new Date()});
	 ...
	 $('#myModal img').attr('src',"farmerInspectionNopGroupReport_getImage.action?id="+id+"&dt="+new Date());
 }
