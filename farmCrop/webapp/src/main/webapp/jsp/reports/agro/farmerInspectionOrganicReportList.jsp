...
<body>
	...
	jQuery(document).ready(function(){
		...
		jQuery("#detail").jqGrid(
				{
				   	url:'farmerInspectionOrganicReport_data.action?',
			...
			jQuery("#detail").jqGrid('setGridParam',{url:"farmerInspectionOrganicReport_data.action?",page:1})
			.trigger('reloadGrid');	
	...
	function exportXLS() {
	    if (isDataAvailable("#detail")) {
	        ...
	        jQuery("#detail").jqGrid('excelExport', {url: 'farmerInspectionOrganicReport_populateXLS.action?'});
	}     else {
	        alert('<s:text name="export.nodata"/>');
	    }
	}
	function onFilterData(){
		callAjaxMethod("farmerInspectionOrganicReport_populateFarmerList.action","farmerId");
		callAjaxMethod("farmerInspectionOrganicReport_populateFarmList.action","farmId");
	...
	<s:form name="form" id="filter" action="farmerInspectionOrganicReport_list">
		...
		<section class='reportWrap row'>
				...
				<div class="filterEle">
					<label for=""><s:text name="farm" /> </label>
					<div class="form-element">
...
<div class="flexItem text-right flex-right">
	...
	<s:form name="updateform" action="farmerInspectionOrganicReport_detail">
		<s:hidden key="id" />
