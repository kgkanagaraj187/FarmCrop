...
<table border="0" width="100%" class="fstTbl" cellspacing="0">
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			<tr>
				...
				<s:text name="printTitleWarehouseStock" /></td>
				<td>&nbsp;</td>
			</tr>
		</table>
		</td>
	...
	<tr class="rNoRow">
		<td><span class="fontBold"><s:text name="printRecNo" /></span>&nbsp;<s:property
			value="warehouseMap['recNo']" /></td>
		<td align="left"><span class="fontBold secondTdSpan"><s:text name="print.date" /></span>&nbsp;<s:property
			value="warehouseMap['date']" />&nbsp;<span style="font-size:12px">(DD-MM-YYYY)</span></td>
	</tr>
	...
	<tr>
		<td style="word-break: break-all;"><span class="fontBold firstTdSpan"><s:text name="print.vendorId" /></span>&nbsp;<s:property
			value="warehouseMap['vId']" /></td>
		<td style="word-break: break-all;"><span class="fontBold secondTdSpan"><s:text
			name="print.vendorName" /></span>&nbsp;<s:property
			value="warehouseMap['vName']" /></td>
	</tr>
	<tr class="borderTop">
		<td class="fontBold" colspan="2"><s:text name="print.orderNo" /> <s:property
			value="warehouseMap['orderNo']" /> </td>
	</tr>
	<%-- <tr>
	...
	<tr>
		...
		<table width="100%" border="0" class="subTable" cellpadding="0"
			...
			<tr class="grayHeader">
				...
				<th width="10%"><s:text name="productName" /></th>
				<th width="10%"><s:text name="warehouseProduct.unit" /></th>
				<!--  <th width="10%"><s:text name="print.expDate" /></th>-->
				<th width="10%"><s:text name="print.costPrice" /></th>
				<th width="10%"><s:text name="print.good" /></th>
				<th width="10%"><s:text name="print.dam" /></th>
				<th width="10%"><s:text name="print.toQty" /></th>
				<th width="10%"><s:text name="print.amt" /></th>
				<s:if test="enableBatchNo==1">
				<th width="10%"><s:text name="print.batchNo" /></th>
				</s:if>
			</tr>
			<s:if test='warehouseMap.productMapList.size()>0'>
				<s:iterator value="warehouseMap.productMapList" var="gListMap">
					<tr>
						<td style="word-break: break-all;"><s:property value="category" /></td>
						<td style="word-break: break-all;"><s:property value="product" /></td>						
						<td class="alnRht"><s:property value="unitType"/></td>
						<!--<td class="alnRht"><s:property value="expDate" /></td>-->
						<td class="alnRht"><s:property value="costPrice" /></td>
						<td class="alnRht"><s:property value="goodQty" /></td>
						<td class="alnRht"><s:property value="badQty" /></td>
						<td class="alnRht"><s:property value="totalQty" /></td>
						<td class="alnRht"><s:property value="totalStockVal" /></td>
						<s:if test="enableBatchNo==1">
...
<table border="0" width="100%" >
	<tr >
		<td class="fontBold" colspan="7" align="right"><s:text
			name="print.totalAmt" /></td>
		<td align="right" width="10%"><s:property
			value="warehouseMap['totalAmt']" /></td>
	</tr>
	<tr>
		<td class="fontBold" colspan="7" align="right"><s:text
			name="print.taxAmt" /></td>
		<td align="right" width="10%"><s:property
			value="warehouseMap['totalTax']" /></td>
	</tr>
	<tr>
		<td class="fontBold" colspan="7" align="right"><s:text
			name="print.finalAmount" /></td>
		<td align="right" class="finalBalCls" width="10%"><s:property
			value="warehouseMap['finalAmount']" /></td>
	</tr>
	<!--<tr>
...
<table border="0" width="100%" cellspacing="0" class="padding10">
	...
	<tr>
		...
		<table width="100%" border="0" class="subTable" cellpadding="0"
			cellspacing="0">
			<s:if test="warehouseMap['payMode']=='Cash'">
				<tr class="grayHeader">
				...
				<tr>
					<td align="left"><s:property value="warehouseMap['payMode']" /></td>
					<td class="alnRht"><s:property value="warehouseMap['payAmt']" /></td>
					<td align="left"><s:property value="warehouseMap['remarks']" /></td>
			   </tr>
			</s:if>
			<s:if test="warehouseMap['payMode']=='Credit'">
				<tr class="grayHeader">
					<th><s:text name="print.PaymentMode" /></th>
			   ...
			   <tr>
					<td align="left"><s:property value="warehouseMap['payMode']" /></td>
					<td class="alnRht"><s:property value="warehouseMap['credAmt']" /></td>
					<td align="left"><s:property value="warehouseMap['remarks']" /></td>
			   </tr>
			</s:if>
		</table>
