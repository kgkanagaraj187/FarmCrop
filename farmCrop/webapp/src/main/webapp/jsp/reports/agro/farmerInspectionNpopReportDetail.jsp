...
<s:hidden key="farmerInspectionNpopReport.id" id="farmerInspectionNpopReportId" />
<font color="red"> <s:actionerror /></font>

<s:form name="form" cssClass="fillform">
	<s:hidden key="currentPage" />
	<s:hidden key="farmerInspectionNpopReport.id" />
	<s:hidden key="id" />
				...
				<div class="flexWrapper">
					<div class="flexLeft appContentWrapper">
						<div class="formContainerWrapper dynamic-form-con">
							<h2><s:text name="info.farmerInspectionNpopReport" /></h2>
...
<s:form name="cancelform" action="farmerInspectionNpopReport_list">
	<s:hidden key="currentPage" />
...
function getImage(id){
	//alert(id);
	 $('#myModal').modal('show');
	 $('#myModal img').attr('src',"farmerInspectionNpopReport_getImage.action?id="+id+"&dt="+new Date());v
	//modal.open({src: "farmerInspectionNpopReport_getImage.action?id="+id+"&dt="+new Date()});
