...
<s:hidden key="farmerInspectionUtzReport.id"
	id="farmerInspectionUtzReportId" />
				...
				<div class="flexWrapper">
					<div class="flexLeft appContentWrapper">
						<div class="formContainerWrapper dynamic-form-con">
							<h2><s:text name="info.farmerInspectionUtzReport" /></h2>
							<div class="dynamic-flexItem">
								<p class="flexItem"><s:text name="farmerCropProdAnswers.group" /></p>
								<p class="flexItem"><s:property value="wareHouseNameAndId" /></p>
							</div>
							<div class="dynamic-flexItem">
							...
							<div class="dynamic-flexItem">
								<p class="flexItem"><s:text name="farmerCropProdAnswers.inspectionYear" /></p>
								<p class="flexItem"><s:property value="year" /></p>
							</div>
						</div>
					</div>
				</div>
	...
	<table class="table table-bordered aspect-detail mainTable">
		<tr class="odd">
			...
			<s:iterator var="sectionAnswers" status="headerStatus"
				...
				<th><s:property value="#sectionAnswers.sectionName" /></th>
				</tr>
			...
			<tr id="tr<s:property value="#headerStatus.index"/>"
				...
				<td width="95%" colspan="7"
					...
					<table class="table table-bordered aspect-detail" id="tab"
						width="100%" cellspacing="0" style="font-weight: normal;">
										...
										<div class="yui-skin-sam">
											<span class=""> <span class="first-child">
													<button class="btn btn-sts"
														...
														type="button" id="img" class="fa fa-picture-o">
...
<s:form name="cancelform" action="farmerInspectionUtzReport_list">
	<s:hidden key="currentPage" />
</s:form>
...
function exportPDF(){
	document.form.action = 'farmerInspectionUtzReport_populatePdf.action';
...
function getImage(id){
	//modal.open({src: "farmerIn spectionNopReport_getImage.action?id="+id+"&dt="+new Date()});
	 ...
	 $('#myModal img').attr('src',"farmerInspectionUtzReport_getImage.action?id="+id+"&dt="+new Date());
 }
