...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		jQuery("#detail").jqGrid(
				{
				   	url:'farmerInspectionNopGroupReport_data.action?',
		...
		jQuery("#detail").jqGrid('setGridParam',{url:"farmerInspectionNopGroupReport_data.action?",page:1})
			.trigger('reloadGrid');	
	...
	function exportXLS() {
	    if (isDataAvailable("#detail")) {
	        ...
	        jQuery("#detail").jqGrid('excelExport', {url: 'farmerInspectionNopGroupReport_populateXLS.action?'});
	}     else {
	...
	<s:form name="form" action="farmerInspectionNopGroupReport_list">
	...
	<s:form name="updateform" action="farmerInspectionNopGroupReport_detail">
		<s:hidden key="id" />
