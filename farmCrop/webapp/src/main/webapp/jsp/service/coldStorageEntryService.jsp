...
function isEmpty(val){
	...
	jQuery(document).ready(function() {
		...
		if(supplier=="1"){
			jQuery(".supplier").show();
		}else{
			jQuery(".supplier").hide();
		}
		$("#tblData1").hide();
...
function calcNetWeight(){	
		...
		$("#tblData1 tbody")
				.append(
						"<tr class='tableTr1'id='"+rows.length+1+"'>"
								...
								+ "<td align='center'><select style='width:150px' class='tableTd1 txtFilterSelect filSelect form-controm input-sm' id='varietyList' >"
								+ "</select></td>"
	...
	//alert(lossTotal);
		...
		"###"+grossWeight+"###"+procurementDetailId+"###"+dryLoss+"###"+gradingLoss;
	...
	function onEdit(val) {
		...
		jQuery("#tblData1").show();
			...
			//jQuery("#subTotal").val(jQuery("#subTotal"+val+"").text());
	...
	<s:form name="form" cssClass="fillform"
		...
		<div class="appContentWrapper marginBottom">
			<table class="table table-bordered fillform">
				...
				<tr>
					<td style="width: 25%" class="supplier"><s:text
							name="supplier" /></td>
					<td style="width: 25%" class="supplier"><s:property
							value="supplierMaster" /></td>
			...
			<table id="tblData1" class="table table-bordered aspect-detail">
				...
				<thead>
					...
					<tr>
						...
						<s:if test="getCurrentTenantId()!='lalteer'">
							<th style="width: 10%"><s:text name="grossWeights" /> <sup
								style="color: red;">*</sup></th>
						</s:if>
						<s:if test="getCurrentTenantId()=='lalteer'">
							<th style="width: 10%"><s:text name="NetWeight" /> <sup
								style="color: red;">*</sup></th>
							...
							<th style="width: 20%"><s:text name="price" /><sup
							style="color: red;">*</sup></th>
							<th style="width: 20%"><s:text name="subTotal" /><sup
							style="color: red;">*</sup></th>
			...
			<table id="tableTemplate1" style="margin-top: 20px;"
				...
				<thead>
					...
					<tr class="border-less">
						...
						<th style="width: 20%"><s:text name="noofBags" /></th>
						<s:if test="getCurrentTenantId()!='lalteer'">
							<th style="width: 20%"><s:text name="grossWeights" /></th>
						</s:if>
						<s:if test="getCurrentTenantId()=='lalteer'">
						 ...
						 <th style="width: 15%"><s:text name="price" /></th> 
						 <th style="width: 15%"><s:text name="subTotal" /></th> 
				...
				<table class="table table-bordered aspect-detail">
					<thead>
						...
						<tr>
							...
							<td>
							<label for="txt">
							<s:property value="%{getLocaleProperty('procurement.transport.cost')}" />(<s:property value="%{getCurrencyType().toUpperCase()}" />)</label>
							</td>
