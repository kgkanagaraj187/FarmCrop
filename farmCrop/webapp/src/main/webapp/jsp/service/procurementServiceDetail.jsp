...
<body>
	<script type="text/javascript">
		jQuery(document).ready(function() {
			var supplier = '<s:property value="enabledsupplier"/>';
			if (supplier == "1") {
				...
				<div class="appContentWrapper marginBottom">
					<div class="formContainerWrapper dynamic-form-con">
						...
						<div class="reg hide dynamic-flexItem">
							<p class="flexItem">
								<s:property
									value="%{getLocaleProperty('farmerCodeAndName')}" />
							</p>
							<p class="flexItem">
						...
						<div class="unreg dynamic-flexItem">
							<p class="flexItem">
							<s:property
									value="%{getLocaleProperty('farmerName')}" />
							</p>
							<p class="flexItem">
						...
						<s:if test="currentTenantId!='efk' && currentTenantId!='pratibha'">
						...
						<div class="dynamic-flexItem">
							...
							<p class="flexItem">
								<s:property value="procurement.buyer.customerName" />
							</p>
						</div>
						</s:if>
					...
					<div class="formContainerWrapper">
						...
						<table class="table table-bordered table-hover fillform">
							<tr>
								...
								<th style="width: 15%" align="center"><s:property value="%{getLocaleProperty('noofBags')}" /></th></s:if>
								<s:if test="currentTenantId=='awi'">
								<th style="width: 15%" align="center"><s:text
										name="noofFruitBags" /></th></s:if>
								...
								<th style="width: 15%" align="center"><s:property value="%{getLocaleProperty('Price')}" /></th>
								<th style="width: 15%" align="center"><s:text
										name="SubTotal" /></th>
						...
						value="procurementGrade.code" /></td> --%>
								...
								<td style="width: 15%"><s:property
									...
									<td style="width: 15%" align="right"><s:property
											value="numberOfBags" /></td></s:if>
									<s:if test="currentTenantId=='awi'">
									<td style="width: 15%" align="right"><s:property
											value="numberOfFruitBags" /></td></s:if>
									<td style="width: 15%" align="right"><s:property
							...
							<div class="formContainerWrapper">
								...
								<div class="flexiWrapper filterControls">
									<table class="table table-bordered aspect-detail">
										...
										<td><label for="txt"><s:property
													value="%{getLocaleProperty('procurement.transport.cost')}" />(<s:if test="currentTenantId=='pratibha'"><s:property value="%{getLocaleProperty('priceUnit')}"/> </s:if><s:else><s:property value="%{getCurrencyType().toUpperCase()}" /></s:else>)</label></td>
								...
								<span id="update" class=""><span class="first-child">
										<button type="button" onclick="onUpdate();"
											...
											<FONT color="#FFFFFF"> <b><s:property
													value="%{getLocaleProperty('edit.button')}" /></b>
											</font>
										</button>
								</span></span>
							</sec:authorize>
