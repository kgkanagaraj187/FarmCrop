...
$(document).ready(function(){	
	...
	{
	   	url:'distributionToFieldStaff_data.action',
...
<s:form name="createform" action="distributionToFieldStaff_create">

</s:form>
<s:form name="detail" action="distributionToFieldStaff_detail">
	<s:hidden key="id" />
