...
$(document).ready(function(){	
	...
	jQuery("#detail").jqGrid(
			{
			   	url:'researchStation_data.action',
                ...
                styleUI : 'Bootstrap',
			   	...
			   	colModel:[
					<s:if test='branchId==null'>
			   		...
			   		{name:'researchStationId',index:'researchStationId',width:125,sortable:true},
			   		{name:'name',index:'name',width:125,sortable:true},	
			   		{name:'pointPerson',index:'pointPerson',width:125,sortable:true},	
			   		{name:'designation',index:'designation',width:125,sortable:true}	   		
			   		//{name:'division',index:'division',width:125,sortable:true}
...
<s:form name="createform" action="researchStation_create">
</s:form>
<s:form name="updateform" action="researchStation_detail">
	<s:hidden name="id" />
