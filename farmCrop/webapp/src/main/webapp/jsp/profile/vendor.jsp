				...
				<div class="appContentWrapper marginBottom">
					...
					<div class="formContainerWrapper">
						...
						<div class="flexiWrapper">
							...
							<%-- <div class="flexi flexi10">
									<label for="txt"><s:text name="vendor.landLine" /></label>
									<div class="form-element">
										<s:textfield name="vendor.landLine" theme="simple" maxlength="11"/>
									</div>
							</div>--%>
							...
							<div class="flexi flexi10">
									...
									<div class="form-element">
										<s:textfield name="vendor.mobileNumber" theme="simple" maxlength="10"/>
									</div>
							</div>
							...
							<div class="flexi flexi10">
									...
									<div class="form-element">
									<s:textfield name="vendor.email" theme="simple" maxlength="90" />
									</div>
							</div>
						</div>
