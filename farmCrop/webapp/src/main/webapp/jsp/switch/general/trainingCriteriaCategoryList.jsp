...
<script type="text/javascript">
	$(document).ready(function(){
		...
		{
		   	url:'trainingCriteriaCategory_data.action',
		   	...
		   	colNames:[
				...
				<s:if test='isMultiBranch=="1"&&(getIsParentBranch()==1||branchId==null)'>
					'<s:text name="app.subBranch"/>',
		  			...
		  			'<s:text name="trainingCriteriaCategory.code"/>',
		  		   '<s:text name="trainingCriteriaCategory.name"/>'
		      	 	 ],
		   	colModel:[	
					<s:if test='branchId==null'>
...
<sec:authorize ifAllGranted="profile.trainingMaster.topicCriteriaCategory.create">
...
<s:form name="createform" action="trainingCriteriaCategory_create">
</s:form>
<s:form name="updateform" action="trainingCriteriaCategory_detail">
	<s:hidden key="id" />
