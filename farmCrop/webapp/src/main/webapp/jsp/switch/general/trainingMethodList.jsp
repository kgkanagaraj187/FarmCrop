		...
		jQuery("#detail").jqGrid(
		{
		   	...
		   	colNames:[
					...
					'<s:text name="app.subBranch"/>',
		  		   	  ...
		  		   	  '<s:text name="trainingMethod.code"/>',
		  		      '<s:text name="trainingMethod.name"/>'
		      	 	 ],
		   	colModel:[	
		   	   	   	<s:if test='branchId==null'>
...
<sec:authorize ifAllGranted="profile.trainingMaster.trainingMethod.create">
...
<s:form name="createform" action="trainingMethod_create">
</s:form>
<s:form name="updateform" action="trainingMethod_detail">
	<s:hidden key="id" />
