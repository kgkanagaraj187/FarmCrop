...
<body>
<s:form name="form" cssClass="fillform" action="creationFarmer_createList" 	method="post" enctype="multipart/form-data" id="target">
<s:hidden id="componentDatas" name="componentDatas"/>
		...
		<div class="formContainerWrapper">
			...
			<div class="flexiWrapper">
				<div class="flexform-item">
					<label for="txt">List Type<sup style="color: red;">*</sup></label>
					<div class="form-element">
						<s:select list="componentList" name="listType" id="listType"/>
					</div>
				</div>
	...
	<script>
		...
		function addTable() {
			var listTypeId = getElementValueById("listType");
		...
		function duplicateRow(obj) {
			...
			var tr = $("<tr/>");
			tr.append(td("listTypeText", trow.find(".listTypeText").html()));
			tr.append(td("compoText", trow.find(".compoText").html()));
			tr.append(td("compoName", ""));

			tr.append(td("listTypeId hide", trow.find(".listTypeId").html()));
		...
		function save() {
			...
			$("#fList").find("tr").each(function(i, v) {
				var trow = $(this);
				var listTypeId = trow.find(".listTypeId").html();
