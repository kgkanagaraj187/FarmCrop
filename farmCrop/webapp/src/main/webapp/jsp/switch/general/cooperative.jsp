			...
			<div class="formContainerWrapper">
				...
				<div class="flexform">
					...
					<s:if test="currentTenantId=='chetna' || currentTenantId=='livelihood'">
						<div class="flexform-item">
							<label for="txt"><s:text name="coOperative.typez" /></label>
							<div class="form-element">
								<s:select id="warehouseType" name="warehouse.typez"
									list="warehouseType" theme="simple"
									cssClass="form-control input-sm select2" />
							</div>
						</div>
						<div class="flexform-item">
							<label for="txt"><s:text
									name="%{getLocaleProperty('coOperative.latitude')}" /></label>
							<div class="form-element">
								<s:textfield name="warehouse.latitude" theme="simple"
									maxlength="45" cssClass="form-control input-sm" />
							</div>
						</div>
						<div class="flexform-item">
							<label for="txt"><s:text
									name="%{getLocaleProperty('coOperative.longitude')}" /></label>
							<div class="form-element">
								<s:textfield name="warehouse.longitude" theme="simple"
									maxlength="45" cssClass="form-control input-sm" />
							</div>
						</div>
					</s:if>
