...
<s:form name="form" cssClass="fillform" action="targetGroup_%{command}">
	...
	<table class="table table-bordered aspect-detail">
		...
		<%-- 
		<tr class="odd">
			<td width="35%"><s:text name="targetGroup.code" /><sup
				style="color: red;">*</sup></td>
			
			<td width="65%">
			<s:if test='"update".equalsIgnoreCase(command)'>
					<s:property value="targetGroup.code" />
						<s:hidden key="targetGroup.code" />
				</s:if>
				<s:else>
					<s:textfield name="targetGroup.code" theme="simple" maxlength="35"/>
		...
		<tr class="odd">
			<td width="35%"><s:text name="targetGroup.name" /><sup
				style="color: red;">*</sup></td>
			<td width="65%"><s:textfield name="targetGroup.name"  maxlength="45" theme="simple" /></td>
		</tr>
