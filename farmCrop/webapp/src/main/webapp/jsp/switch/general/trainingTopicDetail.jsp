...
<s:hidden key="trainingTopic.id" id="trainingTopicId"/>
<font color="red">
    <s:actionerror/></font>
<s:form name="form" cssClass="fillform">
	...
	<table class="table table-bordered aspect-detail">
		...
		<tr class="odd">
			<td width="35%"><s:text name="trainingTopic.code" /></td>
			<td width="65%"><s:property value="trainingTopic.code"/>&nbsp;</td>
		</tr>
		
		<tr class="odd">
			<td width="35%"><s:text name="trainingTopic.name" /></td>
			 <div style="width:430px;" class="break-word">
			<td width="65%"><s:property value="trainingTopic.name" />&nbsp;</td>
			</div>
		</tr>
...
<div class="yui-skin-sam">
    <sec:authorize ifAllGranted="profile.trainingMaster.trainingTopic.update">
    ...
    </sec:authorize> <sec:authorize ifAllGranted="profile.trainingMaster.trainingTopic.delete">
...
<s:form name="updateform" action="trainingTopic_update.action">
    <s:hidden key="id"/>
    <s:hidden key="currentPage"/>
</s:form>
<s:form name="deleteform" action="trainingTopic_delete.action">
    <s:hidden key="id"/>
    <s:hidden key="currentPage"/>
</s:form>
...
$(document).ready(function () {
    $('#update').on('click', function (e) {
        document.updateform.id.value = document.getElementById('trainingTopicId').value;
    ...
    $('#delete').on('click', function (e) {
        if (confirm('<s:text name="confirm.delete"/> ')) {
            document.deleteform.id.value = document.getElementById('trainingTopicId').value;
