...
<sec:authorize ifAllGranted="profile.trainingMaster.targetGroup.create">
...
<s:form name="createform" action="targetGroup_create">
</s:form>
<s:form name="updateform" action="targetGroup_detail">
	<s:hidden key="id" />
