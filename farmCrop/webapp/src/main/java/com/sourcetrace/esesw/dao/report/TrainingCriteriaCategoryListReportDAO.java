/*
 * TrainingCriteriaCategoryListReportDAO.java
...
public class TrainingCriteriaCategoryListReportDAO extends ReportDAO {

    protected void addExampleFiltering(Criteria criteria, Map params) {

        // check for filter entity
        TopicCategory entity = (TopicCategory) params.get(FILTER);
