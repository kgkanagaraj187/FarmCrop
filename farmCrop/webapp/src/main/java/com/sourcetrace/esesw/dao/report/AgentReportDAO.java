...
public class AgentReportDAO extends ReportDAO {
	...
	protected void addExampleFiltering(Criteria criteria, Map params) {
		...
		if (entity != null) {
			...
			if(entity.getAgentType()!=null && !ObjectUtil.isEmpty(entity.getAgentType()) && entity.getAgentType().getCode()!=null && !StringUtil.isEmpty(entity.getAgentType().getCode()) && !entity.getAgentType().getCode().equals("-1")){
