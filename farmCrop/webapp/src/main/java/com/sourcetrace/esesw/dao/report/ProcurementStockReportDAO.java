...
public class ProcurementStockReportDAO extends ReportDAO {
	...
	protected void addExampleFiltering(Criteria criteria, Map params) {
		...
		if (entity != null) {
			...
			if (!ObjectUtil.isEmpty(entity.getProcurementProduct()) && !StringUtil.isEmpty(entity.getProcurementProduct().getUnit()))
				{
				criteria.add(Restrictions.eq("pp.unit", entity.getProcurementProduct().getUnit()));
			}
