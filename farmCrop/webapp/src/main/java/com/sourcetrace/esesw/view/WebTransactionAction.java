...
import com.ese.view.service.AgroTimerTask;
...
public class WebTransactionAction extends SwitchValidatorAction {
    ...
    protected IPreferencesService preferncesService;
    ...
    public void populateTimerCount() {
        ...
        try {
            ...
            if (ObjectUtil.isEmpty(myTask) || myTask.isCancelled()) {
                myTask = new AgroTimerTask(agentId, agentService, preferncesService);
