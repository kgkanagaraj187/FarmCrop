...
public class VillageValidator implements IValidator {
    ...
    public Map<String, String> validate(Object object) {
        ...
        if (StringUtil.isEmpty(aVillage.getCity().getLocality().getState()
            ...
            Country country = locationDAO.findCountryByName(aVillage.getCity()
        ...
        if (StringUtil.isEmpty(aVillage.getCity().getLocality().getState()
            ...
            State state = locationDAO.findStateByCode(aVillage.getCity()
        ...
        if (StringUtil.isEmpty(aVillage.getCity().getLocality().getCode())) {
            ...
            Locality locality = locationDAO.findLocalityByCode(aVillage
        ...
        if (StringUtil.isEmpty(aVillage.getCity().getCode())) {
            ...
            city = locationDAO.findMunicipalityByCode(aVillage.getCity()
            		.getCode());
        ...
        if (StringUtil.isEmpty(aVillage.getGramPanchayat().getCode())) {
            ...
            gramPanchayat = locationDAO.findGramPanchayatByCode(aVillage.getGramPanchayat()
                    .getCode());
        ...
        */
        if (values == null || values.length == 0) {
        	if (!ObjectUtil.isEmpty(aVillage.getGramPanchayat())&&!StringUtil.isEmpty(aVillage.getGramPanchayat().getCode())) {
        		GramPanchayat grampanchayat=locationDAO.findGramPanchayatByCode(aVillage.getGramPanchayat().getCode());
        		if(!ObjectUtil.isEmpty(grampanchayat)){
        		Village villageExist=locationDAO.findDuplicateVillageName(grampanchayat.getId(),aVillage.getName());
