...
public class FarmerInspectionReportDAO extends ReportDAO {
	...
	protected void addExampleFiltering(Criteria criteria, Map params) {
		...
		FarmerCropProdAnswers entity = (FarmerCropProdAnswers) params.get(FILTER);
		...
		if (entity != null) {
			...
			criteria.add(Restrictions.like("categoryCode", entity.getCategoryCode(), MatchMode.EXACT));
			...
			if (!StringUtil.isEmpty(entity.getFarmerId())) {
				criteria.add(Restrictions.like("farmerId", entity.getFarmerId(), MatchMode.EXACT));
			}

			if (!StringUtil.isEmpty(entity.getFarmId())) {
				criteria.add(Restrictions.like("farmId", entity.getFarmId(), MatchMode.EXACT));
			}
		}
