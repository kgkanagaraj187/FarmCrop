    ...
    if (null != src && src.length() > 0) {
        ...
        if (src.startsWith("data:image/")) {
            ...
            try {
                ...
                Float width = attributes.get(HTML.Attribute.WIDTH)==null || attributes.get(HTML.Attribute.WIDTH)=="" ? 100f :  utils.parsePxInCmMmPcToPt( attributes.get(HTML.Attribute.WIDTH));
                Float heifht = attributes.get(HTML.Attribute.HEIGHT)==null || attributes.get(HTML.Attribute.HEIGHT)=="" ? 100f :  utils.parsePxInCmMmPcToPt( attributes.get(HTML.Attribute.HEIGHT));
                img.scaleAbsolute(width,heifht);
            } catch (Exception e) {
